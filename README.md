...
### Алгоритм решения
сделать цикл который добавляет в строку итератор, пока он не станет 0(включительно)
...
результат: 32
### Алгоритм решения
цикл который y раз уножает x на само себя
...
результат: false
### Алгоритм решения
в цикле сравнивать каждую цифру с предыдущей(с конца) и уменьшать число
...
****`
### Алгоритм решения
два цикла, где один в другом и один отвечает за высоту, а другой до ширину
...
### Алгоритм решения
сравнивать в цикле случайно сгенерированное число с тем что вводит пользователь, пока тот не угадает и добавлять попытки в счетчик + вспомогательная функция для скланений слова "попытка" в зависимости от результата
